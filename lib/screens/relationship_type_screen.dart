...
class _RelationshipTypeScreenState extends State<RelationshipTypeScreen> {
  ...
  Future<void> _saveRelationshipTypeAndContinue() async {
    ...
    try {
      await _profileService.upsertProfile(
        ...
        relationshipType: _selected.toList(), // Convert Set to List
        relationshipTypeVisible: _visibleOnProfile,
      );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save relationship type: $e')),
        );
      }
    } finally {
            ...
            Positioned(
              ...
              child: GestureDetector(
                ...
                onTapUp: (_) {
                  ...
                  _saveRelationshipTypeAndContinue();
                },
                child: Container(
                  width: 72,
                  height: 72,
