...
class _FamilyPlansScreenState extends State<FamilyPlansScreen> {
  ...
  Future<void> _saveFamilyPlansAndContinue() async {
    ...
    try {
      await _profileService.upsertProfile(
        ...
        familyPlans: _selected,
        familyPlansVisible: _visibleOnProfile,
      );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save family plans: $e')),
        );
      }
    } finally {
