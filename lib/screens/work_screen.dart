...
class _WorkScreenState extends State<WorkScreen> {
  ...
  Future<void> _saveWorkAndContinue() async {
    final work = _controller.text.trim();
    if (work.isEmpty || _currentUser == null || _loading) return;
