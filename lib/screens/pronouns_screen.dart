...
class _PronounsScreenState extends State<PronounsScreen> {
  ...
  Future<void> _savePronounsAndContinue() async {
    ...
    try {
      await _profileService.upsertProfile(
        ...
        pronouns: _selected.toList(), // Convert Set to List for Supabase
        pronounsVisible: _visibleOnProfile,
      );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save pronouns: $e')),
        );
      }
    } finally {
