  ...
  Future<void> _saveBeliefsAndContinue() async {
    ...
    try {
      await _profileService.upsertProfile(
        ...
        religiousBeliefs: _selected.toList(), // Convert Set to List
        religiousBeliefsVisible: _visibleOnProfile,
      );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save religious beliefs: $e')),
        );
      }
    } finally {
