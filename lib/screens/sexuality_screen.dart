...
class _SexualityScreenState extends State<SexualityScreen> {
  ...
  Future<void> _saveSexualityAndContinue() async {
    ...
    try {
      await _profileService.upsertProfile(
        ...
        sexuality: _selected,
        sexualityVisible: _visibleOnProfile,
      );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save sexuality: $e')),
        );
      }
    } finally {
