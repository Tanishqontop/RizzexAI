...
class _SmokeWeedScreenState extends State<SmokeWeedScreen> {
  ...
  Future<void> _saveWeedStatusAndContinue() async {
    ...
    try {
      await _profileService.upsertProfile(
        ...
        weedStatus: _selected,
        weedStatusVisible: _visibleOnProfile,
      );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save weed status: $e')),
        );
      }
    } finally {
