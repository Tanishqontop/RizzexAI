...
class _StudyScreenState extends State<StudyScreen> {
  ...
  Future<void> _saveStudyAndContinue() async {
    final education = _controller.text.trim();
    if (education.isEmpty || _currentUser == null || _loading) return;
    ...
    try {
      await _profileService.upsertProfile(
        ...
        education: education,
        educationVisible: _visibleOnProfile,
      );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save education: $e')),
        );
      }
    } finally {
